...
class Cautomobile{
    ...
    public:
        ...
        int set_brand(const std::string);
        int set_price(const double);
        int set_model(const std::string);
        int set_year(const unsigned int);
        int set_lin_plate(const std::string);
