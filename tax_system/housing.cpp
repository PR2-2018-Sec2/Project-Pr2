...
int CHousing::set_type_housing(const std::string n){
     this->type_housing = n;
    return 0;
}
...
int CHousing::set_size(const float n){
    if(n<1000 or n>0)
    {
        this->size = n;
        return 0;
...
/// \~English @param String \~Spanish @param Cadena
int CHousing::set_address(const std::string n){
     this->address = n;
    return 0;
}
/// \~English @brief Changing city value \~Spanish @brief Cambiar ciudad
/// \~English @param String \~Spanish @param Cadena
int CHousing::set_city(const std::string n){
     this->city = n;
     return 0;
}
