...
class Cbank_account { 
	...
	public:
        ...
        Cbank_account(double,std::string,std::string,std::string,std::string,std::string);
        /// \~English Parametric Constructor \~Spanish Constructor parametrico
        ...
        int set_balance (const double);
        int set_account_number (const std::string);
        int set_account_type (const std::string);
        int set_id (const std::string);
        int set_email (const std::string);
        int set_bank(const std::string);
